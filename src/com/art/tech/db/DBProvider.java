...
public class DBProvider extends ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch(witch){
		case IMAGES:
			rowId = insert(ImageCacheColumn.TABLE_NAME,null,values);
			break;			
		}
		return null;
	}
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch(witch){
		case IMAGES:
			count = delete(ImageCacheColumn.TABLE_NAME,selection,selectionArgs);
			notifyChange(uri);
			break;
		}
		return count;
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case IMAGES:
			count = update(ImageCacheColumn.TABLE_NAME,values,selection,selectionArgs);
			notifyChange(uri);
			break;
		}
		return count;
